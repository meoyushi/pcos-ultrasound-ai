...
export default function CombinedPredict() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${API}/api/predict/combined`, {
        method: "POST",
        body: formData,
      });
    ...
    <div className="page-wide fade-in">
      {loading && (
        <div className="spinner-overlay">
          ...
          <p className="spinner-text">Running combined analysis…</p>
        </div>
      )}
      ...
      <div className="page-header">
        ...
        <p>Provide both your clinical details and an ultrasound image for the most comprehensive prediction.</p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="combined-layout">
          {/* Left — Clinical form */}
          <div className="card">
            <h3 style={{ fontFamily: "'DM Serif Display', serif", marginBottom: 20, color: "var(--sage-dark)" }}>
              Clinical Data
            </h3>
          ...
          <div className="card">
            ...
            >
              ...
              <p className="drop-zone-text">
                {file ? "Click or drag to replace" : "Drag & drop image"}
              </p>
              <p className="drop-zone-hint">JPG, PNG, WebP</p>
            </div>
